...
<head>
<title>ECommerce Register Insert Page</title>
...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="E_Login.jsp">E-commerce website </a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="logo">
        <h1><a href="index.html" class="style1">Characterizing and Predicting Early Reviewers for Effective Product Marketing on E-Commerce Websites</a></h1>
      </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		<h2><span class="style2">E Commerce Website Register Status...</span></h2>
  ...
  try 
  {
					...
					File file1 = null;	
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("ECommerce"))
							{
								ecom=multi.getParameter(paramname);
							}
						...
						String str = "select * from ecommerce where username='"+uname+"' ";
						...
						<p align="center"><a href="E_Register.jsp">Back</a></p><%
						
						}
			 			else
						{
					   
						PreparedStatement ps=connection.prepareStatement("insert into ecommerce(username,password,email,mobile,dob,gender,address,location,status,image,ename) values(?,?,?,?,?,?,?,?,?,?,?)");
					...
					%>
					<h3 class="style3">E-Commerce Website Registered Successfully</h3>
					<p align="center"><a href="E_Login.jsp">Login..</a> <a href="E_Register.jsp">Back</a></p><%
						}
						}
					catch (Exception e) 
					{
