...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
         <h2><span class="style2">User <%=request.getParameter("type1")%>'s Profile</span></h2>
	  ...
	  <h2>&nbsp;</h2>
			...
			if(type.equalsIgnoreCase("sametraj")){%>
            <h2 align="right"><a href="U_SameUserTraject.jsp" class="style4">Back</a></h2>
			<%}
