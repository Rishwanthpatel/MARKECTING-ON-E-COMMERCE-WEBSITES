          ...
          <table width="601" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <%
						...
						try 
						{
							...
							String query1="select * from products where   erdt>='"+strCurrDate+"' "; 
						...
						while ( rs1.next() )
						   	...
						   	String query="select * from pcomment where pname='"+s11+"'   "; 
			 ...
			 <td width="116" rowspan="1" ><div class="style22 style4 style5" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
			  ...
			  <td  valign="baseline" height="0"><p class="style22 style4 style5">&nbsp;</p>
                  ...
                  <div align="center" class="style22 style4 style5">
                    ...
                    <a href="A_UserProfile1.jsp?value=<%=s3%>&name=<%=s3%>">  <%out.println(s3);%></a>
          ...
          <table width="601" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <%
						...
						try 
						{
							...
							String query1="select * from products where   erdt<='"+strCurrDate1+"' "; 
						   	Statement st1=connection.createStatement();
						   	ResultSet rs1=st1.executeQuery(query1);
						while ( rs1.next() )
					   		{
						   	...
						   	String query="select * from pcomment where pname='"+ss11+"'   "; 
						   	Statement st=connection.createStatement();
						   	ResultSet rs=st.executeQuery(query);
					   		while ( rs.next() )
					   		{
			 ...
			 <td width="116" rowspan="1" ><div class="style22 style4 style5" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
			  ...
			  <td  valign="baseline" height="0"><p class="style22 style4 style5">&nbsp;</p>
                  ...
                  <div align="center" class="style22 style4 style5">
                    ...
                    <a href="A_UserProfile1.jsp?value=<%=s333%>&name=<%=s333%>">  <%out.println(s333);%></a>
