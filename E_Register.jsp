...
<head>
<title>E Commerce Website Registration Page</title>
...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="E_Login.jsp"><span>e-commerce website </span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="logo">
        <h1><a href="index.html" class="style3">Characterizing and Predicting Early Reviewers for Effective Product Marketing on E-Commerce Websites</span></a></h1>
      </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
           <h2><span class="style1">E-Commerce Website Registration Form</span></h2>
           <p>&nbsp;</p>
           <p align="center"><img src="images/Register.jpg" width="201" height="107" /></p>
           <p>&nbsp;</p>
           <form name="s" method="post" enctype="multipart/form-data" action="E_RegIns.jsp" onSubmit="return valid()"  ons>
	...
	<tr>
	<td>
	  <div align="right" class="style4 style2"><span class="style13"><font size="+1">Select E-Commerce Website :</font> </span></div></td>
	<td><select name="ECommerce">
	  <option>Flip Cart</option>
	  <option>Infibeam</option>
	  <option>Ebay</option>
	  <option>Futurebazaar</option>
	  <option>Yebhi</option>
        </select></td>
	</tr>
	...
	<td><input type="submit" value="Register" id="button1"><input type="reset" value="clear"></td>
     ...
     <p>&nbsp;</p>
	 <br>
	 <p align="right"><a href="E_Login.jsp" class="style3">Back</a></p>
          <div class="clr"></div>
        </div>
        <p class="pages">&nbsp;</p>
      </div>
