...
<head>
<title>E-Commerce Website  Main Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style2">Wel-Come User :: <%=(String)application.getAttribute("ename")%></span></h2> <h2><span class="style2">Ecommerce Website :: <%=(String)application.getAttribute("eweb")%></span></h2>
          <p class="infopost">&nbsp;</p>
          <p class="infopost">&nbsp;</p>
         <p class="infopost"><img src="images/ecom.jpg" width="626" height="249" /></p>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style3">
		    <li><strong><a href="E_Profile.jsp">My Profile</a></strong></li>
			<li><strong><a href="E_AddProduct.jsp">Add Products</a></strong></li>
			<li><strong><a href="E_View_All_Products.jsp">View All Products with reviews</a></strong></li>
			<li><strong><a href="E_View_All_earlyreviews.jsp">View All Early Product's  reviews</a></strong></li>
			<li><strong><a href="E_View_All_Purchased_Transactions.jsp">View All Purchased Transactions </a></strong></li>
