    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost"><img src="images/User.jpg" width="650" height="249" /></p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style3">
			...
			<li><strong><a href="U_Manage_Account.jsp">Manage Account</a></strong></li>
			 <li><strong><a href="U_Search.jsp">Search Products By Keyword</a></strong></li>
			 <li><strong><a href="U_Search_Keywords.jsp">View All Your Search Transaction</a></strong></li>
			 			 <li><strong><a href="U_View_Purchased_Transactions.jsp">View All Your Purchased Products</a></strong></li>
